  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="mt-8 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
        ...
        <p className="mb-2">
          Enter a pubkey in the input field and click &quot;Set&quot; to set the current account.
          The account display component will update to show the pubkey.
        </p>
        <p>
          Click &quot;Clear Account&quot; to set the current account to null.
          The account display component will update to show &quot;No account selected&quot;.
        </p>
      </div>
    </div>
  );
